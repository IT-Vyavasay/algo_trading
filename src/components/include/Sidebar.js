    ...
    <>
          ...
          <div id='sidebar-menu'>
            <ul className='metismenu' id='side-menu'>
              ...
              <li className={`${path == '/dashboard' ? 'mm-active' : ''}`}>
                <Link
                  href={`/${process.env.ADMFLDR}/dashboard`}
              ...
              <li className='menu-title'>Manage Coin</li>
              <li className={`${path == '/coinlist' ? 'mm-active' : ''}`}>
                <Link
                  href={`/${process.env.ADMFLDR}/coinlist`}
                  className={`${path == '/coinlist' ? 'active' : ''}`}
                >
              ...
              <li
                className={`${
                  path == '/membership-plan-list' ? 'mm-active' : ''
                }`}
              >
                <Link
                  href={`/${process.env.ADMFLDR}/membership-plan-list`}
                  className={`${
                    path == '/membership-plan-list' ? 'active' : ''
                  }`}
                >
              ...
              <li
                className={`${
                  path == '/user-membership-plan' ? 'mm-active' : ''
                }`}
              >
                <Link
                  href={`/${process.env.ADMFLDR}/user-membership-plan`}
                  className={`${
                    path == '/user-membership-plan' ? 'active' : ''
                  }`}
                >
              ...
              <li
                className={`${path == '/notify-email-list' ? 'mm-active' : ''}`}
              >
                <Link
                  href={`/${process.env.ADMFLDR}/notify-email-list`}
                  className={`${path == '/notify-email-list' ? 'active' : ''}`}
                >
              ...
              <li className={`${path == '/contactus-list' ? 'mm-active' : ''}`}>
                <Link
                  href={`/${process.env.ADMFLDR}/contactus-list`}
                  className={`${path == '/contactus-list' ? 'active' : ''}`}
                >
              ...
              <li className={`${path == '/voucher-list' ? 'mm-active' : ''}`}>
                <Link
                  href={`/${process.env.ADMFLDR}/voucher-list`}
                  className={`${path == '/voucher-list' ? 'active' : ''}`}
                >
              ...
              <li className={`${path == '/faq-list' ? 'mm-active' : ''}`}>
                <Link
                  href={`/${process.env.ADMFLDR}/faq-list`}
                  className={`${path == '/faq-list' ? 'active' : ''}`}
                >
              ...
              <li
                className={`${
                  path == '/term-and-condition' ? 'mm-active' : ''
                }`}
              >
                <Link
                  href={`/${process.env.ADMFLDR}/term-and-condition`}
                  className={`${path == '/term-and-condition' ? 'active' : ''}`}
                >
              ...
              <li className={`${path == '/privacy-policy' ? 'mm-active' : ''}`}>
                <Link
                  href={`/${process.env.ADMFLDR}/privacy-policy`}
                  className={`${path == '/privacy-policy' ? 'active' : ''}`}
                >
              ...
              <li className={`${path == '/configuration' ? 'mm-active' : ''}`}>
                <Link
                  href={`/${process.env.ADMFLDR}/configuration`}
                  className={`${path == '/configuration' ? 'active' : ''}`}
                >
      ...
      <Modal show={show} className='' size='sm'>
        ...
        <Modal.Footer className='d-flex justify-content-center py-1'>
          <button
            className='btn btn-bordered-light waves-effect btn-sm waves-light'
            onClick={() => setShow(false)}
          >
            No
          </button>
          <button
            className='btn btn-bordered-primary waves-effect btn-sm waves-light'
            onClick={() => logout()}
          >
