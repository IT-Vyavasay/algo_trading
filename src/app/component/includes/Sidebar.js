              ...
              <ul className='sidebar-links' id='simple-bar'>
                ...
                <li className='sidebar-list'>
                  ...
                  <ul className='sidebar-submenu'>
                    ...
                    <li>
                      <a href='dashboard-03.html'>Online course</a>
                    </li>
                    <li>
                      <a href='dashboard-04.html'>Crypto</a>
                    </li>
                    <li>
                      <a href='dashboard-05.html'>Social</a>
                    </li>
                    <li>
                      <a href='dashboard-06.html'>NFT</a>
                    </li>
                    <li>
                      {' '}
                      <a href='dashboard-07.html'>School management</a>
                    </li>
                    <li>
                      {' '}
                      <a href='dashboard-08.html'>POS</a>
                    </li>
                  </ul>
                </li>
                <li className='sidebar-list'>
